...
Approach: We use a heat map to see the relationship between the type of violation and the resulted injure including the fatality injury.
...
Analysis: Based on the plot, we found that violations of speed , crosswalk , failure to yield have higher fatalities.
