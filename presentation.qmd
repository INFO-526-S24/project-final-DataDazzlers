...
-   We use the **GIS Data from the City of Tucson**, which contains publicly-available records of vehicle collisions from the Tucson Police Department covering the period from March 2022 to the present.
...
-   Fewer accidents occur in summer months than winter months.
    ...
    ![](images/yearly_plot.PNG){fig-align="center"}{height="90%"}{width ="90%"}
